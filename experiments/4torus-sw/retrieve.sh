...
rsync $OPTIONS $REMOTEUSER@$REMOTELOCATION:~/projects/magnetization/experiments/4torus-sw/output/tape/ ./output/tape/
rsync $OPTIONS $REMOTEUSER@$REMOTELOCATION:~/projects/magnetization/experiments/4torus-sw/output/statistics/ ./output/statistics/
