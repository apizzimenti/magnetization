...
OPTIONS="--verbose --human-readable --update --recursive"
...
rsync $OPTIONS $IGNORE ./ $REMOTEUSER@$REMOTELOCATION:/home/$REMOTEUSER/projects/magnetization/experiments/4torus-sw
