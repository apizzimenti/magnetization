...
schedule = randomizedToConstant(steps=steps, field=q, hold=1/4, distribution=np.random.normal)
...
chain = Chain(lattice, model, initial=initial, sampleInterval=100, steps=steps)
